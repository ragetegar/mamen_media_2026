                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <div className="flex gap-1 mt-6">
                            <a
                                href="https://www.instagram.com/mamen.ld"
                                target="_blank"
                                ...
                                aria-label="Mamen on Instagram (@mamen.ld)"
                            >
                            ...
                            <a
                                href="https://x.com/mamenofficial"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-10 h-10 flex items-center justify-center text-mamen-gray-200 hover:border-mamen-lime hover:text-mamen-lime transition-colors"
                                aria-label="Mamen on X (@mamenofficial)"
                            >
                            ...
                            <a
                                href="https://www.tiktok.com/@mamen.ld"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-10 h-10 flex items-center justify-center text-mamen-gray-200 hover:border-mamen-lime hover:text-mamen-lime transition-colors"
                                aria-label="Mamen on TikTok (@mamen.ld)"
                            >
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
